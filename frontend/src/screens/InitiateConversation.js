...
const presetPrompts = [
  {
    title: 'Rescheduling',
    content: 'Ask client to reschedule their appointment. Use the getUpcomingAppointment tool to get the appointment details for the appointment that is between August 24th and 29th, 2024. Then use this appointment date to reschedule this appointment. I am going on vacation from the 24th to the 30th so don’t offer appointments during those days. If a customer asks when can I book offer appointments after the 30th. Call clearCustomPrompt after the appointment is rescheduled or if the customer aknowledges the request',
